    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-4 sm:p-5 border-b md:border-r">
          <span className="font-medium">Extremely secure shroud for Night Vision Devices</span>
        </div>
        <div className="p-4 sm:p-5 border-b">
          <span className="font-medium">Manually adjustable mechanism</span>
        </div>

        {/* Row 2 */}
        <div className="p-4 sm:p-5 border-b md:border-r bg-gray-50">
          <span className="font-medium">Quick and easy installation. No gunsmith and tool required</span>
        </div>
