...
export default function ThermalMonocularPage() {
  return (
    <>
            ...
            The DarVi Thermal Monocular is engineered with a high-performance
             VOx thermal detector and a high-resolution display,
              delivering sharp, detailed thermal imagery for reliable detection and identification.
               An advanced intelligent image-processing algorithm effectively suppresses noise and enhances contrast, 
               ensuring a clear and stable thermal image even in challenging environments.
              <br /><br />
             Designed for performance in complete darkness, smoke, light fog, and through foliage,
              the DarVi Thermal Monocular provides extended detection capability beyond the limits of conventional optics.
               Its compact and ergonomic design makes it ideal for covert surveillance,
                critical infrastructure protection,
                 border security, law enforcement, and high-threat tactical operations,
                  where precision, reliability, and rapid response are essential.
            </p>
          </div>
        </div>
      </section>
    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 text-xl font-semibold">
        ...
        <div className="p-4 sm:p-5 border-b bg-gray-50">
          <span className="font-medium">Color Palettes:</span> Multiple
        </div>
        ...
        <div className="p-4 sm:p-5 border-b">
          <span className="font-medium">Connectivity:</span> Live video via Wi-Fi
        </div>
