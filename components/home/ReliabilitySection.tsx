  ...
  return (
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        {/* LEFT CONTENT */}
        <div>
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[var(--primary-blue)] mb-4 sm:mb-6 leading-tight">
          ...
          {/* <button className="border border-gray-300 px-5 sm:px-6 py-2.5 sm:py-3 rounded-md text-sm sm:text-base hover:bg-[var(--primary-blue)]
